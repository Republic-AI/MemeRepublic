...
import com.infinity.ai.chat.task.chat.ChatTask;
import com.infinity.ai.chat.task.chat.QueryChatTask;
import com.infinity.ai.chat.task.system.RefreshTask;
import com.infinity.ai.chat.task.user.LogoutTask;
import com.infinity.ai.chat.task.user.RefreshGameUserTask;
...
public class NewTaskFactory implements ITaskFactory {
    ...
    static {
        ...
        NewTaskFactory.register(com.infinity.common.msg.ProtocolCommon.kChatCommand, ChatTask::new);
        NewTaskFactory.register(com.infinity.common.msg.ProtocolCommon.kQueryChatCommand, QueryChatTask::new);
